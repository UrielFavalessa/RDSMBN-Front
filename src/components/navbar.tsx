      ...
      <div ref={ref} className="flex items-center">
        ...
        <div className="bg-green-grass sm:bg-surface font-anton flex h-[94px] w-full flex-row items-center">
          <div>
            <Link href="/">
              <Image
                className="ml-6 hidden cursor-pointer transition-[filter] duration-300 hover:filter-[invert(35%)_sepia(40%)_saturate(500%)_hue-rotate(80deg)_brightness(85%)] sm:block md:ml-8 2xl:ml-20"
                src="./rdsmbn-logo.svg"
                alt="RDSMBN logo"
                width={60}
                height={60}
              />
              <Image
                className="ml-6 cursor-pointer transition-[filter] duration-300 hover:filter-[invert(35%)_sepia(40%)_saturate(500%)_hue-rotate(80deg)_brightness(85%)] sm:hidden md:ml-8 2xl:ml-20"
